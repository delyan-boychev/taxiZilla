        ...
        data=>
        {
            ...
            data.forEach(order => {
               ...
               <span class="font-weight-bold">Оценка: </span>
                ...
                if(order["rate"] != 0 && order["orderStatus"] == "CLOSED") `<br><span class="font-weight-bold">Оценка: </span> ${ratingStars[order["rate"]]}<br><span class="font-weight-bold">Коментар: </span> ${ratingComment}`;
